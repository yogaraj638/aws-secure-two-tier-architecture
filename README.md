...
* **Security Groups:** * **Bastion:** Allows SSH (22) from My IP.
   ...
   <div align="center">
  <h3>VPC Infrastructure Resource Map</h3>
  <img src="Resource%20Map.png" alt="AWS Resource Map" width="900">
  <p><i>Visual verification of Subnet associations and Route Table connectivity.</i></p>
</div>
